...
create table obj_descriptors_cat(
...
CREATE OR REPLACE TRIGGER trigger_be_ins_obj_desc_cat BEFORE INSERT ON obj_descriptors_cat FOR EACH ROW EXECUTE PROCEDURE check_desc_inst_exists();
...
obj_desc_cat integer references obj_descriptors_cat(id),
...
FOREIGN KEY (object, desc_inst) REFERENCES obj_desc_inst (object, desc_inst),
FOREIGN KEY (object, desc_cat) REFERENCES obj_descriptors_cat (object, desc_cat),
