...
def compare_databases(counts1: Dict, counts2: Dict, samples1: Dict, samples2: Dict, 
...
def main():
    ...
    parser.add_argument('--method', choices=['quantdb', 'ingestion', 'both'], 
                       default='both', help='Which ingestion method to run')
    parser.add_argument('--no-clear', action='store_true', 
                       help='Do not clear database before ingestion')
    parser.add_argument('--compare-only', action='store_true',
                       help='Only compare existing databases without running ingestion')
    ...
    if args.method == 'both' and not args.compare_only:
        ...
        match = compare_databases(
            counts_quantdb, counts_ingestion,
            samples_quantdb, samples_ingestion,
            "quantdb/ingest.py", "ingestion/"
        )
