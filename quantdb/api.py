...
fake_users_db = {
    "johndoe": {
        ...
        "hashed_password": "$2b$12$aAiVBQPAPb6Vx86veokFt.iWwxxPPpvsZJEDhGzjLGySYgR3ck5Jq",  # password: secret
        "disabled": False,
    }
}
...
@fastapi_app.get("/users/me/items", response_model=list[Item])
async def read_own_items(current_user: User = Depends(get_current_active_user)):
    fake_items_db = [
        {"item_id": 1, "owner": current_user.username, "description": "Item 1 description"},
        {"item_id": 2, "owner": current_user.username, "description": "Item 2 description"},
    ]
